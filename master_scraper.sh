...
pytnon scrapers.py --state_code HR --type pdf --url _inputs/hr.pdf


## Image States (download / crop them first)
python scrapers.py --state_code AR --type image --url _inputs/ar.jpeg
python scrapers.py --state_code CT --type image --url _inputs/ct.jpeg
python scrapers.py --state_code MP --type image --url _inputs/mp.jpeg

# NOTE: Bihar has 2 images
python scrapers.py --state_code BR --type image --url _inputs/br.jpeg
python scrapers.py --state_code BR --type image --url _inputs/br2.jpeg